<template>
  <div>
    ...
    <div class="header-menu">
      <el-input placeholder="搜索新闻" v-model="keyword" @clear="inputListener" clearable>
...
<!--      <el-table-column prop="classNo" label="班级" fixed width="100"></el-table-column>-->
      ...
      <el-table-column prop="type" label="类型" >
        <template slot-scope="scope">
          <el-tag v-if="scope.row.type==1" plain >疗养休养</el-tag>
          <el-tag v-else-if="scope.row.type==2" plain>工会活动</el-tag>
          <el-tag v-else-if="scope.row.type==3" plain>社团活动</el-tag>
          <el-tag v-else-if="scope.row.type==4" plain>慰问活动</el-tag>
        </template>
      </el-table-column>
...
<script>
  import {add,del,modify,get,search} from "@/api/news";
